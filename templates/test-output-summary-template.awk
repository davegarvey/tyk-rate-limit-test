BEGIN {
    ...
    printf "%-*s  %-*s  %-*s  %-*s  %-*s  %-*s  %-*s  %-*s  %-*s  %-*s  %-*s  %-*s  %-*s\n",
        ...
        res_429_width, "Res 429", res_other_width, "Res Other", rl_pass_width, "RLW Pass",
        rl_fail_width, "RLW Fail", rl_success_percent_width, "RLW Pass %", rate_200_width, "200 Rate",
