...
for test_plan in "${test_plans_to_run[@]}"; do
    ...
    # case $test_data_source in
        # "requests")
            ...
            # api_id=$(create_api $api_file_path)
            # token=$(create_bearer_token $key_file_path)
            # echo "api_id:$api_id token:$token"
            ...
            analytics_data=$(get_analytics_data $api_id $current_time $load_total)
